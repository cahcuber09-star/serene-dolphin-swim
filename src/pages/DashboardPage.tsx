...
const DashboardPage: React.FC = () => {
  ...
  // We subscribe to a dummy topic here since we only need the client/connection status and publish function.
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 sm:p-8">
      ...
      <div className="mb-8 flex flex-col items-center">
        <ToggleGroup 
          ...
          className="bg-card p-1 rounded-lg shadow-md mb-6"
        >
